...
'''
# YOUR CODE HERE
index = list(number_dict['cs251']).index(4)
...
# YOUR CODE HERE
mydict= {"shoe_store": [], "music_store": [],
}
print(mydict)

for i, item in enumerate(delivery):
    if item is "shoes":
        mydict["shoe_store"].append("shoes")
    else:
        mydict["music_store"].append("music")
    print("After adding item ", i)
    print("shoe_store: ", mydict['shoe_store'])
    print("music_store: ", mydict["music_store"])
