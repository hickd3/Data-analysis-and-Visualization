...
class CatData(data.Data):
    ...
    def __init__(self, filepath=None, headers=None, data=None, header2col=None, cats2levels=None):
        ...
        self.unfilitered = copy.deepcopy(self.data)
    ...
    def get_cat_levels_str(self, header):
        ...
        '''
        cat_levels= self.cats2levels[header]
        return np.array(cat_levels)
    ...
    def get_cat_levels_int(self, header):
        ...
        '''
        cat_int_levels = [self.cats2levels[header].index(i) for i in self.cats2levels[header]]
        return np.array(cat_int_levels)
    ...
    def int2strlevels(self, header, int_levels):
        ...
        '''
        cat_levels= self.cats2levels[header]
        int_2str= [cat_levels[int] for int in int_levels]
        return int_2str
    ...
    def str2intlevels(self, header, str_levels):
        ...
        '''
        cat_levels= self.cats2levels[header]
        str_2int= [cat_levels.index(i) for i in str_levels]
        return str_2int
    ...
    def reset_dataset(self):
        ...
        '''
        self.data= np.array(self.unfilitered)
    ...
    def filter(self, header, strlevel):
        ...
        filtered_data = self.data[np.squeeze(self.data[:, col_index] == int_level)]
